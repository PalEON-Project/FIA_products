...
## fit stats model
biomass_total <- fit(cell_full, newdata = pred_grid_west, k_occ = NULL, k_pot = k_pot_total, return_model = TRUE, unc = TRUE, type_pot = 'log_arith', num_draws = n_stat_samples, save_draws = TRUE)
