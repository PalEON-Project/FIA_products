...
output_netcdf_name <- paste0("FIA_density_v", product_version, ".nc")
output_netcdf_name_point <- paste0("FIA_density_point_v", product_version, ".nc")
...
make_albers_netcdf(name = 'density', longname = 'density, stems greater than 8 inches dbh per hectare,', units = "stems/ha",
